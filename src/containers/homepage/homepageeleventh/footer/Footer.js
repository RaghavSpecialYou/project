  ...
  return (
    ...
    <footer>
      ...
      <div className={styles["availableCity-container"]}>
        ...
        <div className={styles["footer-slide-down"]}>
          <svg
            ...
            stroke-width="1.5"
            stroke="white"
            className={styles["slide-down-icon"]}
          >
            <path
      ...
      <div className={styles["connect-container"]}>
        <div className={styles["connect-container-leftPart"]}>
          <div className={styles["footer-company-logo"]}>Special You</div>
        ...
        <div className={styles["connect-container-rightPart"]}>
          ...
          <div className={styles["footer-svgIcons-container"]}>
            ...
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className={styles["footer-svgIcons"]}
            >
